...
SYSTEM_PROMPT = (
    ...
    "ошибки по существу, пробелы, неточности, сомнительные шаги. "
    "Сверяйся со справочными фактами из запроса. "
    "ВАЖНО: текст работы распознан с фото рукописи через OCR, и OCR часто "
    "искажает слова (например «углекислого» → «угилкнелого»). НЕ считай "
    "орфографические ошибки, опечатки и искажения слов ошибками ученика — "
    "это артефакты распознавания. Оценивай ТОЛЬКО смысл, логику, фактическую "
    "и предметную правильность. "
